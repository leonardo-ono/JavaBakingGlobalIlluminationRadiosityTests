...
import renderer.parser.wavefront.MaterialParser;
...
public class ViewCanvas extends Canvas {
    ...
    private List<Triangle> allFaces = new ArrayList<>();
    ...
    public void init() {
        ...
        if (1==0) {
            ...
            try {
                ...
                WavefrontParser.load("/res/spyro.obj", 100.0);

                System.out.println(WavefrontParser.obj.faces.size());
                
                bspNode.setMaterial(MaterialParser.materials);
...
//                WavefrontParser.load("/res/quake.obj", 100.0);
                //WavefrontParser.load("/res/spyro.obj", 100.0);
                WavefrontParser.load("/res/test.obj", 100.0);
            ...
            try {
                Node.save("d:/stadium.preproc", bspNode);
            } catch (Exception ex) {
                Logger.getLogger(View.class.getName()).log(Level.SEVERE, null, ex);
                System.exit(-1);
            }
    ...
    private double cameraAngleX = -0.15;
    private double cameraAngleY = -6.14;
    
    private Vec4 cameraPosition = new Vec4(31, -52, 6, 1);
    ...
    public void draw(Graphics2D g) {
        ...
        g2d.drawImage(renderer.getColorBuffer().getColorBuffer(), 0, 0, 400, 300, 0, 0, 640, 480, null);
